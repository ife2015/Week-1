/*
write a function that will swap values between two objects. Your function will receive four parameters:
...
const swapper = function(key1, object1, key2, object2) {
  console.log('Swap!');
  // get the value of key1 of obj1 and store it
  // put the value of key2 into key1
  // put the value of key1 into key2
  

  let value = object1[key1];
